...
class bosonstar(relaxation_method):
    def init(self,
             ...
             m2=1e-10,
             fr=1e17):
        # paramer of the relaxation algorithm 
        self.slowc = 1.0

        # mass of the scalar in eV converted to GeV
        self.mphi = m1*1.e-9
        # mass ratio of the two scalars
        self.mr = m2/m1

        # Graviational Constant in GeV
        self.G_N = 6.70883e-39
        # fr is a term that appears in the self coupling of the scalars
        self.fr = fr # in GeV
        # self couplings of the scalars where self.lam1 can be the rescaled value 
        if fr is None:
            self.lam1 = lam1
            self.lam2 = lam2
            self.lam12 = lam12
        ...
        # sign of the mass ratio
        self.c = np.sign(self.mr)

        # tolerance to use in relaxation algorithm 
        self.tol = 1.0e-8
    ...
    def f(self,r,y):
        ...
        r = radial coordinate of the profiles
        y = derivatives of the profiles (see below comments for the positions of each profile)
        """
        #x = t
        #y[0] = A
        #y[1] = phi1
    ...
    def dB1dy(self):
        ...
        n1 = number of boundary conditions at r = 0
    ...
    def dB2dy(self):
        ...
        n2 = number of boundary conditions at r -> infinity
        N = number of differential equations
        """
        #shape n2 x N
    ...
    def findM2(self,r,y):
        """
        Function that calculated the mass contribution of the second scalar.
        Outdated but kept anyways. 
        """
        A = y[0,...]
        p1 = 0*y[1,...]
        p2 = y[2,...]
...
if __name__ == "__main__":
    ...
    x,y,res = _get_profiles(1e-5,2e-5,**kwargs)
